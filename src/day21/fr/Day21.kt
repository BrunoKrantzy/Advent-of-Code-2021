...
fun main(args: Array<String>) {
    ...
    var setXYZon = mutableSetOf<Triple<Int, Int, Int>>()
    ...
    inLines.forEach {
        ...
        val x1 = match!!.groups[2]!!.value.toInt()
        val x2 = match!!.groups[3]!!.value.toInt()
        val y1 = match!!.groups[4]!!.value.toInt()
        val y2 = match!!.groups[5]!!.value.toInt()
        val z1 = match!!.groups[6]!!.value.toInt()
        val z2 = match!!.groups[7]!!.value.toInt()
